...
from transformers import RobertaTokenizer, XLNetTokenizer, DistilBertTokenizer,AutoTokenizer
...
class ParseTree():
    def __init__(self, tokenizer_name, cached_parses=None):
        ...
        if 'xlm-roberta-base' in tokenizer_name:
            self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_name)
        
        elif 'bert' in tokenizer_name:
            self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_name)

        elif 'roberta-base' in tokenizer_name:
            print("1*************************************************")
